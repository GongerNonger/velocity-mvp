    ...
    <div className="min-h-screen bg-gray-950 relative">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          <div className="bg-gray-900/70 backdrop-blur-sm border border-gray-700/60 rounded-2xl p-6 md:p-10">
            ...
            <div key={category} className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {INTEGRATIONS.filter((i) => i.category === category).map((i) => (
                  <article key={i.name} className="bg-gray-900/70 backdrop-blur-sm border border-gray-700/60 hover:border-green-700/50 hover:shadow-lg hover:shadow-green-900/10 transition-all duration-300 rounded-xl p-6">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-3">
            {SECURITY.map((s) => (
              <div key={s.label} className="bg-gray-900/70 backdrop-blur-sm border border-gray-700/60 hover:border-green-700/50 hover:shadow-lg hover:shadow-green-900/10 transition-all duration-300 rounded-xl p-5">
