        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {pricingTiers.map((tier) => {
            ...
            return (
              <div
                key={tier.name}
                className={`rounded-2xl p-6 bg-gray-900 border ${highlight ? "border-green-700" : "border-gray-800"} relative ${highlight ? "md:scale-105" : ""}`}
            ...
            <table className="min-w-full text-sm">
              ...
              <tbody>
                {TIER_FEATURES.map((f, i) => {
                  ...
                  return (
                    <tr key={i} className={i % 2 === 0 ? "bg-gray-950" : "bg-gray-900/30"}>
